...
namespace simulationcontrol {
	...
	unsigned int SimController::AddSubSystem(const groundcontact::GearLuGreFrictionParameter & parameter)
	{
		subsystem_info system_info;
		subsystem_list.emplace_back(new groundcontact::GearLuGreFriction(parameter));
		// update number of subsystems
		num_of_subsystems = subsystem_list.size();
		// returen subystem handle
		return CreateSystemHandle(system_info, subsystem_list);
